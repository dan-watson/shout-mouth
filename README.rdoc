...
- Fully implement the rest of the Wordpress API so Wordpress blogging clients will work with shout mouth.
- Remove saving and projection from model code and implement in its own mappers and service classes for blogging client api's
